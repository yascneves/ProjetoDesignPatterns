...
class Lan implements IConexao 
{
    ...
    public void validar() 
    {
        ...
        if (r == 1)
        {
            status = Constantes.CORAZUL + "Sucesso na conexão via LAN;" + Constantes.CORPADRAO;
        }
        else
        {
            status = Constantes.CORVERMELHA + "Falha na conexão via LAN;" + Constantes.CORPADRAO;
        }
